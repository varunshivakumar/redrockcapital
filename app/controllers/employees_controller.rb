class EmployeesController < ApplicationController
  ...
  def manager_home
    ...
    # client_revenue(stock_type): add revenue generated by a particular customer

    # Manager:(7)
    # Determine which employee generated the most total revenue
    @best_employee_revenue = employee_of_the_month # First value is user_id, Second value is revenue
